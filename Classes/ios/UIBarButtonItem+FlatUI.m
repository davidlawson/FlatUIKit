...
+ (void) configureItemOrProxy:(id)appearance
    ...
    [appearance setBackButtonTitlePositionAdjustment:UIOffsetMake(0.0f, -1.0f) forBarMetrics:UIBarMetricsDefault];
    [appearance setBackButtonTitlePositionAdjustment:UIOffsetMake(0.0f, -1.0f) forBarMetrics:UIBarMetricsLandscapePhone];
